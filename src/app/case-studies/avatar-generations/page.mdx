...
export default function AvatarGenerationsCaseStudy() {
  ...
  const metrics = [
    {
      label: 'Feature Dev Time',
      value: 42,
      suffix: '% ↓',
      description: 'Reduction through documented specs',
      highlight: true,
    },
    {
      label: 'Design Rework',
    ...
    },
    {
      ...
      value: 25,
      suffix: '% ↑',
      description: 'Data-driven iteration',
      highlight: true,
    }
  ]
            ...
            <FocusImageGallery 
              images={[
                ...
                },
                {
                  ...
                  alt: "Standard modal pattern",
                  caption: "One pattern, many contexts: modular modals meant faster builds and consistent UX."
                }
              ]}
            />
          </div>
