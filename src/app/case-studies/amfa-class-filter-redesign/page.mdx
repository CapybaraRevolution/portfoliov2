  ...
  const metrics = [
    {
      ...
      stat: 'Target +15–25%',
      previousStat: 'Baseline TBD',
      change: 'Pending',
      changeType: 'increase',
      description: 'GA4 funnel from filter start → class detail → add-to-cart'
    },
    {
      ...
      change: 'Pending',
      changeType: 'increase',
      description: 'Median time from directory load → class detail'
    },
    {
      name: 'Cart return continuity',
      stat: 'State preserved',
      previousStat: 'Inconsistent state',
      change: 'Improved',
      changeType: 'increase',
      description: 'UAT checklist + post-launch survey'
    }
  ]
  ...
  return (
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics}>
      ...
      <div className="prose prose-zinc dark:prose-invert max-w-none">
        ...
        <ul>
          <li><strong>System map / flow diagram</strong> (current → future) with platform boundaries</li>
