...
export default function CornellUniversityCaseStudy() {
  ...
  const summary = {
    ...
    constraints: [
      'Three schools with distinct identities and stakeholder groups',
      'Complex IA (programs, research, faculty, events) with overlapping content',
      'Serving prospective students, current students, alumni, and faculty',
    ],
    decisions: [
      'Anchored all decisions around 3 validated personas (not stakeholder opinions)',
      'Built a library of 55 reusable page modules with clear inputs, variants, and rules',
      'Designed three-tier navigation (global, sectional, in-page) with naming conventions',
    ],
    impact: [
      'Users found program information in under 2 minutes (usability testing)',
      '55 modules wireframed in a system-first approach',
      '3 core personas defined and validated',
    ],
  }
