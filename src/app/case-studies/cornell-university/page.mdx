  ...
  const approachTimeline = [
    {
      ...
      content: (
        <div className="prose prose-zinc dark:prose-invert max-w-none"> <h3 className="mt-0">Data-Informed, Human-Interpreted</h3>
          <p>I thrive on chaos. Take a big mess and throw me into the deep-end..  I'll come back with charts, graphs and relevant memes.  I started by quantitative analysis (<Tooltip content="Behavior analytics for seeing how people actually navigate via heatmaps, scroll depth, and session replays."><span className="font-bold">Hotjar</span></Tooltip> + <Tooltip content="Google Analytics—traffic and event data that shows what’s happening at scale."><span className="font-bold">GA</span></Tooltip>) with qualitative observation to locate friction and validate what the data couldn’t explain on its own.</p>
          ...
          <Accordion type="single" collapsible className="mt-4">
            <AccordionItem value="nerdy-aside">
              ...
              <AccordionContent>
                  ...
                  <p> I used data the same way you'd use a map, <Tooltip content="Fun Fact: I love maps!"><span className="font-bold">not to admire it</span></Tooltip>, but to plot my course.<em> If I wanted to find the buried treasure I'd first need to know what direction to go. </em> GA & Hotjar heatmaps are wayfinders. They gave me a broad sense of where people were dropping off, and what UI elements they were interacting with most often.
                    <br /><br />
                 
                    Ask any archeologist and they'll tell you that if you want to<em> actually </em> find the treasure, you eventually do have to drop the map, bust out your metal detector and start digging - So there I was, digging through session replays and reviewing Hotjar's screen recordings to see the friction the <Tooltip content={<><span>Seriously, you just watch people click on the same things for hours. </span><em>It's a good thing you're considering paying ME to do this for YOU!</em></>}><span className="font-bold">numbers can't explain</span></Tooltip>.
                  </p>
                  <p>
