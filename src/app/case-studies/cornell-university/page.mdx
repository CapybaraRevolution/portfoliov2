          ...
          <Accordion type="single" collapsible className="mt-4">
            <AccordionItem value="nerdy-aside">
              ...
              <AccordionContent>
                  ...
                  <p> We used data the same way you'd use a map, <Tooltip content="Fun Fact: I love maps!"><span className="font-bold">not to admire it</span></Tooltip>, but to plot your course.<em> If we wanted to find the buried treasure we'd first need to know what direction to go. </em> GA & Hotjar heatmaps are wayfinders. They gave us a broad sense of where people were dropping off, and what UI elements they were interacting with most often.
                    <br /><br />
                  ...
                  <p>
                    ...
                    Our loop stayed intentionally simple. That's why the output wasn't a giant research deck. It was a practical shortlist of "fix this next" items—
    ...
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics}>
      ...
      <ProseSection>
        <ProseBlock>
          ...
          <p>
             I joined the project (via Briteweb). Working as a UX strategist, my job was to somehow attack this messy situation, and change the trajectory toward something resembling a coherent digital experience. We needed to provide rules the team could actually run with, and I was dead-set on creating wireframes and documentation that Cornell's internal team could own and evolve. I approached this like any other project: start by understanding where users fall off. We needed to identify the source of our problems if we wanted to build a system that would prevent these same problems from reappearing.
          </p>
        </ProseBlock>
        <FadeIn delay={0.1}>
          <div className="mt-10">
