    ...
    },
    {
      ...
      content: (
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <p>I owned the component architecture, typography system, and spacing rules—building logic-based components with variables that made the system extensible. This meant clean component structure, naming, <Tooltip content="Design tokens that standardize spacing, color, and typography values so engineers and designers stay in sync."><span className="font-bold">spacing/token logic</span></Tooltip>, and “<Tooltip content="A Product Requirements Document (PRD) is a formal document that outlines what a product should do, who it's for, and how it should behave. PRD-lite is a lightweight version that documents intent, states, and edge cases without the bloat of a full PRD."><span className="font-bold">PRD-lite</span></Tooltip>” specs that reduced interpretation gaps.</p>
        </div>
      ),
    },
  ]
  ...
  return (
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics}>
      ...
      >
        ...
        <p>In 2016, Cornell combined three business schools under the SC Johnson College of Business. By 2024, the web experience still behaved like three separate institutions with different navigation patterns, different terminology, and different page structures. This made even basic tasks hard to navigate.</p>
        <p>Prospective students were the most important users group.They were also one of the most troubled. They were trying to compare programs, understand admissions, and find requirements that could take one of three forms. This mismatch of  "same goal, different layout, different verbiage" created inconsistency. The kind of inconsistency that quietly erodes trust. An especially costly dilemma considering the prospective student was the  highest-priority user journey.</p>
      </SplitSection>
      ...
      <ProseSection>
        <ProseBlock>
          ...
          <p>
             I joined the project (via Briteweb). Working as a UX strategist, my job was to somehow attack this messy situation, and change the trajectory toward something resembling a coherent digital experience. I needed to provide rules the team could actually run with, and I was dead-set on creating wireframes and documentation that Cornell's internal team could own and evolve. I approached this like any other project: start by understanding where users fall off. I needed to identify the source of our problems if we wanted to build a system that would prevent these same problems from reappearing.
          </p>
        </ProseBlock>
        <FadeIn delay={0.1}>
          <div className="mt-10">
