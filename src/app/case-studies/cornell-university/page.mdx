  ...
  const approachTimeline = [
    {
      ...
      content: (
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          <h3 className="mt-0">Insight work (data-informed, human-interpreted)</h3>
    ...
    },
    {
      ...
      content: (
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          <h3 className="mt-0">Module design (system first)</h3>
    ...
    },
    {
      ...
      content: (
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          <h3 className="mt-0"><Tooltip content="A governed set of global, sectional, and in-page patterns with naming/grouping rules so navigation feels predictable everywhere."><span className="font-bold">Navigation system (patterns + rules)</span></Tooltip></h3>
    ...
    },
    {
      ...
      content: (
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          <h3 className="mt-0">Handoff (so it lives beyond us)</h3>
    ...
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics}>
      ...
      <section className="mb-16">
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <ul>
            <li><strong>Time-to-find dropped to under two minutes</strong> for core program information in prototype testing—a directional signal that the IA restructure was working.</li>
            <li><strong>Three core personas defined and socialized</strong> across stakeholders, giving the team a shared reference point for decisions instead of opinion-based debates.</li>
            <li><strong>~55 modules and screens wireframed</strong> to establish the system foundation and reduce one-off design decisions going forward.</li>
            <li><strong>Findability improved</strong> in unmoderated tests on key tasks after IA and navigation prototyping.</li>
            <li><strong>The documented module library</strong> reduced consistency debt and made future page creation calmer and faster for Cornell's internal team.</li>
          </ul>
        </div>
      </section>
