...
export default function BreezeMortgageHubCaseStudy() {
  ...
  const summary = {
    ...
    constraints: 'Greenfield product in a complex regulatory domain (mortgage); solo product designer supporting a CEO directly; needed investor-ready prototypes alongside dev-ready specs.',
    ...
    impact: 'Compressed feature alignment from months of iteration loops to roughly a week per flow; helped secure $2.3M Series A funding.',
  }
