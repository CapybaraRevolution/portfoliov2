  ...
  return (
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics}>
      ...
      >
        ...
        <p>I was brought in as an independent contractor supporting the CEO as a UX lead and product strategist. My job was to turn a loose vision into a coherent system the team could build. If you've ever been the translator between "founder brain" and "what engineers actually need to build," you know this is less about design and more about diplomacy.</p>
      ...
      <ProseSection>
        <ProseBlock>
          ...
          <p>This wasn't a single handoff file. (Those usually collect dust anyway.) It was a connected package:</p>
          <ul>
