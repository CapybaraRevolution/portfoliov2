...
export default function BreezeMortgageHubCaseStudy() {
  ...
  return (
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics} heroImage={heroImage}>
      ...
      {/* The Mess - 50/50 layout with animated beam */}
      ...
      {/* My Role - 50/50 layout with animated beam */}
      <section className="mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="prose prose-zinc dark:prose-invert max-w-none">
      ...
      <section className="mb-16">
        ...
        {/* Carousel placeholder - will be implemented with actual images */}
        <div className="my-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <Figure
            src="/images/case-studies/breeze-mortgage-hub/broker-dashboard.png"
            alt="Broker workflow dashboard"
            caption="Dashboard that turns pipeline status into action"
          />
          <Figure
            src="/images/case-studies/breeze-mortgage-hub/clients-by-stage.png"
            alt="Clients by stage view"
            caption="Filter by stage and work the queue"
          />
          <Figure
            src="/images/case-studies/breeze-mortgage-hub/client-profile.png"
            alt="Client profile with stage indicator"
            caption="Persistent stage indicator keeps brokers oriented"
          />
        </div>
