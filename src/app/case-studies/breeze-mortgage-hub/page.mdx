...
export default function BreezeMortgageHubCaseStudy() {
  ...
  const metrics = [
    {
      label: (<><Tooltip containerClassName="inline" content="A startup's first significant round of venture capital financing, typically used to scale operations after proving product-market fit."><span className="font-bold">Series A</span></Tooltip> Secured</>),
      value: 2.3,
      suffix: 'M',
  ...
  return (
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics}>
      ...
      {/* The Mess - 50/50 layout with icon cloud */}
      <SplitSection
        align="center"
        visual={<IntegrationIconCloud className="h-[380px] w-full" />}
      >
        <Heading id="the-mess" level={2} className="mt-0">The Mess</Heading>
      ...
      <section className="mb-16">
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>A componentized <Tooltip containerClassName="inline" content="A Figma library of reusable components—organized with design tokens (colors, fonts), interaction logic, and even bezier curves for consistent motion."><span className="font-bold">design system</span></Tooltip> foundation with interaction rules and states</li>
            <li><Tooltip containerClassName="inline" content="Deliverables designed to empower teams—wireframes, personas, user journey maps—giving everyone shared context on user needs and product direction."><span className="font-bold">UX artifacts</span></Tooltip> (journeys, <Tooltip containerClassName="inline" content="The structural blueprint of how content and features are organized—mapping where things live and how users navigate between them."><span className="font-bold">IA maps</span></Tooltip>, decision notes) anchored to user outcomes</li>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
          <LearningCard 
            title="In early-stage products, clarity beats velocity."
            icon="Eye"
          >
            Wireframes and prototypes prevent expensive "fast" mistakes later.
          </LearningCard>
          ...
          <LearningCard 
            ...
            icon="Presentation"
          >
            They want to feel the product. Interactive prototypes compress explanation time.
          </LearningCard>

          <LearningCard 
            title="Mortgages are complex. The UX job is to keep the experience calm and predictable."
            icon="Heart"
          >
            While the system carries the complexity: clear status, clear steps, the right guidance, and low <Tooltip containerClassName="inline" content="The mental effort required to use something—good design minimizes this by making interfaces intuitive and predictable."><span className="font-bold">cognitive load</span></Tooltip>.
          </LearningCard>
        </div>
      </section>
    </CaseStudyViewer>
