    ...
    <CaseStudyViewer caseStudy={caseStudy} metrics={metrics}>
      ...
      <ProseSection>
        ...
        <ProseBlock delay={0.1} className="mt-8">
          ...
          <p>
            From there, I could iterate in natural language. "Make the QR code bigger." "Add seat information below the date." "Put a hamburger menu in the header." Natural language iteration itself isn't new to me—I use it constantly in Cursor for code. But starting in Figma, in the design environment I already know, and then bridging directly into AI-powered refinement? That's different. The speed compounds. You're not context-switching between tools or translating mental models. You're just... moving faster.
          </p>
        </ProseBlock>
        ...
        <ProseBlock delay={0.2}>
          <p>
            The time I saved on boilerplate meant more time on the decisions that actually matter: interaction patterns, information hierarchy, the stuff that makes a prototype <em>useful</em> instead of just pretty.
          </p>
        </ProseBlock>
      </ProseSection>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            {/* Design Decision Cards - 2-up at md, back to 1-up at xl when side-by-side with prototype */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-4">
              ...
              {/* Explore box spans full width */}
              <div className="md:col-span-2 bg-zinc-50 dark:bg-zinc-800/30 rounded-xl p-5 border border-zinc-200 dark:border-zinc-700">
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
      ...
      <ProseSection>
        ...
        <ProseBlock delay={0.15} className="mt-8">
          ...
          <ul>
            ...
            <li>What does <Tooltip containerClassName="inline" content="A ticketing and CRM platform used by performing arts organizations worldwide."><span className="font-bold">Tessitura's</span></Tooltip> API actually return? (The middleware doesn't exist yet)</li>
          ...
          <p>
            The temptation is to wait until you have answers. But waiting means the developers have nothing to work with. So instead, you design <em>interfaces</em> that define the contract without defining the implementation.
          </p>
        </ProseBlock>
