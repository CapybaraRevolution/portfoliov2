...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'border-border z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] dark:bg-zinc-950',
        className,
      )}
    >
      {children}
...
export function AnimatedBeamMultipleOutputDemo({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        'relative flex h-[420px] w-full items-center justify-center overflow-hidden rounded-3xl border border-emerald-100/60 bg-gradient-to-br from-emerald-50 via-white to-emerald-100/50 p-8 shadow-xl dark:border-emerald-900/40 dark:from-zinc-900 dark:via-zinc-950 dark:to-emerald-950/30',
        className,
      )}
      ref={containerRef}
    >
...
const Icons = {
  ...
  whatsapp: () => (
    <svg width="32" height="32" viewBox="0 0 175.216 175.552" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <filter id="a" width="1.115" height="1.114" x="-0.057" y="-0.057" colorInterpolationFilters="sRGB">
      ...
      />
      <path
        d="M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.312-6.179 22.558 23.146-6.069 2.235 1.324c9.387 5.571 20.15 8.518 31.126 8.524h.023c33.707 0 61.14-27.426 61.153-61.135a60.75 60.75 0 0 0-17.895-43.251 60.75 60.75 0 0 0-43.235-17.928z"
        fill="url(#b)"
      />
      <path
  ...
  messenger: () => (
    <svg width="32" height="32" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        fill="#ffffff"
        d="M34.394,18.501l-5.7,4.22c-0.61,0.46-1.44,0.46-2.04,0.01L22.68,19.74c-1.68-1.25-4.06-0.82-5.19,0.94l-1.21,1.89-4.11,6.68c-0.6,0.94,0.55,2.01,1.44,1.34l5.7-4.22c0.61-0.46,1.44-0.46,2.04-0.01l3.974,2.991c1.68,1.25,4.06,0.82,5.19-0.94l1.21-1.89l4.11-6.68C36.434,18.901,35.284,17.831,34.394,18.501z"
      />
    </svg>
  ),
  user: () => (
