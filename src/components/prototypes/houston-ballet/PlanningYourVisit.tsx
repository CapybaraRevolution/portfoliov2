  ...
  return (
    ...
    >
      ...
      <div className="px-[17px] pt-12 pb-4 sticky top-0 bg-[#322F3C] z-10">
        ...
        <h1 className="text-white">Planning Your Visit</h1>
      ...
      <div className="px-4 pt-6 space-y-4">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="h-40 bg-[#F6F6F6] border border-[#888295]/20 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-[#322F3C]">Wortham Theater Center</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1">
              <h3 className="text-gray-900 mb-1">Arrival Time</h3>
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1">
              <h3 className="text-gray-900 mb-1">Parking & Transit</h3>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between py-2 border-t border-gray-100">
                  ...
                  <span className="text-gray-900">Varies</span>
                </div>
                <div className="flex items-center justify-between py-2 border-t border-gray-100">
                  <span className="text-gray-700">METRORail</span>
                  <span className="text-gray-900">Theater District Station</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-gray-900 mb-1">Dining Options</h3>
              <p className="text-sm text-gray-600 mb-3">
                Make it a special evening with pre-show dining at these nearby restaurants:
              </p>
              <div className="space-y-2">
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-900">Vic & Anthony&apos;s Steakhouse</p>
                  <p className="text-xs text-gray-500">0.2 miles • Fine Dining</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-900">Brennan&apos;s of Houston</p>
                  <p className="text-xs text-gray-500">0.3 miles • Contemporary Creole</p>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-900">The Grove</p>
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-gray-900 mb-1">Dress Code</h3>
              <p className="text-sm text-gray-600">
        ...
        <div className="bg-white rounded-xl shadow-md p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-gray-900 mb-1">Accessibility Services</h3>
        ...
        <div className="bg-[#F6F6F6] border border-[#888295]/30 rounded-xl p-4 text-center">
          ...
          <p className="text-[#322F3C] mb-1">(713) 227-ARTS</p>
