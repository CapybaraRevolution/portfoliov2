  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full overflow-hidden">
        ...
        {/* Left fade mask - closer to viewport edges */}
        <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-16 z-[4] bg-gradient-to-r from-white via-white/30 to-transparent dark:from-zinc-900 dark:via-zinc-900/30 dark:to-transparent" />
        
        {/* Right fade mask - closer to viewport edges */}
        <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-16 z-[4] bg-gradient-to-l from-white via-white/30 to-transparent dark:from-zinc-900 dark:via-zinc-900/30 dark:to-transparent" />
