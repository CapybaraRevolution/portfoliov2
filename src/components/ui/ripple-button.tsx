      ...
      >
        ...
        <span className="pointer-events-none absolute inset-0">
          {buttonRipples.map((ripple) => (
            <span
              className="animate-rippling bg-background absolute rounded-full opacity-10"
              key={ripple.key}
              style={{
...
interface LinkRippleButtonProps
...
export const LinkRippleButton = React.forwardRef<
  HTMLAnchorElement,
  LinkRippleButtonProps
>(
  (
    {
      className,
...
LinkRippleButton.displayName = "LinkRippleButton"
