      ...
      >
        <defs>
          <style>{`
            ...
            .safari-interactive:hover {
              opacity: 0.7;
            }
            .safari-interactive:active {
              opacity: 0.5;
            }
            .safari-button {
              pointer-events: auto;
        ...
        >
          ...
          />
          {/* Traffic light buttons with larger rectangular hitboxes */}
          <rect x="10" y="10" width="40" height="40" className="safari-hitbox" />
          <circle
            cx="27"
            cy="25"
            r="6"
            className="safari-button fill-[#E5E5E5] dark:fill-[#404040]"
          />
          <rect x="30" y="10" width="40" height="40" className="safari-hitbox" />
          <circle
            cx="47"
            cy="25"
            r="6"
            className="safari-button fill-[#E5E5E5] dark:fill-[#404040]"
          />
          <rect x="50" y="10" width="40" height="40" className="safari-hitbox" />
          <circle
            cx="67"
            cy="25"
            r="6"
          ...
          <path
            ...
            className="safari-url-bar fill-[#E5E5E5] dark:fill-[#404040]"
          />
          ...
          <g className="mix-blend-luminosity safari-url-bar">
            <text
              x="580"
              y="30"
              fill="#A3A3A3"
          ...
          {mode === "default" ? (
            <>
              {/* Back button with larger hitbox */}
              <rect x="250" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
              ...
              {/* Refresh button with larger hitbox */}
              <rect x="915" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
              ...
              {/* Plus button with larger hitbox */}
              <rect x="1120" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
              ...
              {/* Share button with larger hitbox */}
              <rect x="1150" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
              ...
              {/* Reader button with larger hitbox */}
              <rect x="1085" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
              ...
              {/* Bookmarks button with larger hitbox */}
              <rect x="85" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
              ...
              {/* Back navigation with larger hitbox */}
              <rect x="130" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
              ...
              {/* Forward navigation with larger hitbox */}
              <rect x="155" y="10" width="40" height="40" className="safari-hitbox" />
              <g className="mix-blend-luminosity safari-interactive">
                <path
