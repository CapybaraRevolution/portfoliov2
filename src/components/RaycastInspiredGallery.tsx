  ...
  return (
    <div className="not-prose rounded-3xl border border-zinc-900/5 bg-white/70 p-6 shadow-xl ring-1 ring-white/60 backdrop-blur-sm dark:border-white/10 dark:bg-zinc-900/60 dark:ring-white/5 sm:p-8">
      <div className="flex flex-wrap items-baseline justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-zinc-600 dark:text-zinc-400">
            Borrowed from the Raycast feel you liked—hover to see each system flex and breathe.
          </p>
        </div>
      </div>
            ...
            >
              ...
              <div className="raycast-fig-shell relative mt-2 overflow-hidden rounded-2xl border border-emerald-100/70 bg-gradient-to-br from-emerald-50 via-white to-emerald-100/60 p-4 transition duration-500 group-hover:border-emerald-200 group-hover:shadow-lg dark:border-emerald-900/40 dark:from-emerald-900/30 dark:via-zinc-900 dark:to-emerald-800/20">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div
                    className="raycast-toggle"
                    data-active={isActive}
                    aria-label="Toggle animation"
                  >
                    <span>Off</span>
                    <span>On</span>
                    <div className="raycast-toggle-knob" />
                  </div>
                </div>
                <div
                  className="raycast-fig relative mt-3 w-full"
                  data-active={isActive}
                  style={
                    {
                      '--base': colors.base,
      ...
      <style jsx global>{`
        ...
        .raycast-fig[data-active='true'] {
          transform: translateY(-6px) scale(1.01);
          filter: drop-shadow(0 20px 55px rgba(16, 185, 129, 0.25));
        }

        .raycast-fig svg .ApiFig2_screen__QvgLu,
        .raycast-fig svg .ApiFig2_appleLogo__y7S2e {
          transition: transform 420ms ease, filter 420ms ease, opacity 320ms ease;
          transform-origin: center;
        }

        .raycast-fig[data-active='true'] svg .ApiFig2_screen__QvgLu {
          transform: translateY(-4px);
          filter: drop-shadow(0 10px 25px rgba(59, 130, 246, 0.4));
        }

        .raycast-fig[data-active='true'] svg .ApiFig2_appleLogo__y7S2e {
          transform: translate(2px, -2px);
          opacity: 1;
        }

        .raycast-fig svg .ApiFig3_indicator__5kNam,
        .raycast-fig svg .ApiFig4_indicator__pwWSD {
          transition: transform 420ms ease, opacity 320ms ease;
          transform-origin: center;
          opacity: 0.8;
        }

        .raycast-fig[data-active='true'] svg .ApiFig3_indicator__5kNam {
          transform: translateY(-3px) scale(1.04);
          opacity: 1;
        }

        .raycast-fig[data-active='true'] svg .ApiFig4_indicator__pwWSD {
          transform: translateY(-2px);
          opacity: 1;
        }

        .raycast-fig svg .ApiFig4_root__DBWj1,
        .raycast-fig svg .ApiFig3_root__gbCCE {
          transition: filter 400ms ease;
        }

        .raycast-fig[data-active='true'] svg .ApiFig4_root__DBWj1,
        .raycast-fig[data-active='true'] svg .ApiFig3_root__gbCCE {
        ...
        .raycast-toggle[data-active='true'] {
          border-color: rgba(6, 95, 70, 0.6);
          background: rgba(6, 95, 70, 0.12);
          color: #ecfdf3;
        }

        .raycast-toggle[data-active='true'] span:last-child {
          opacity: 1;
        }

        .raycast-toggle[data-active='true'] span:first-child {
          opacity: 0.5;
        }

        .raycast-toggle[data-active='false'] span:first-child {
          opacity: 1;
        }
        ...
        .raycast-toggle[data-active='true'] .raycast-toggle-knob {
...
export function RaycastFigureCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`raycast-fig-shell relative mt-3 overflow-hidden rounded-2xl border border-emerald-100/70 bg-gradient-to-br from-emerald-50 via-white to-emerald-100/60 transition duration-500 group-hover:border-emerald-200 group-hover:shadow-lg dark:border-emerald-900/40 dark:from-emerald-900/30 dark:via-zinc-900 dark:to-emerald-800/20 ${
          isCompact ? 'p-3' : 'p-4'
        }`}
      >
        <div className="pointer-events-none absolute inset-0">
        ...
        <div
          className="raycast-fig relative w-full"
          data-active={active}
          style={
            {
              '--base': colors.base,
