...
import houstonBalletLogo from 'figma:asset/ceb7b57d2b9ee52032a8d168d0d96c527a22c790.png';
      ...
      >
        ...
        <div className="flex items-center justify-center">
          <div className="w-[120px] h-[50px] flex items-center justify-center">
            <img src={houstonBalletLogo} alt="Houston Ballet" className="w-full h-full object-contain" />
          </div>
        </div>
      </motion.div>
        ...
        <div className="flex flex-col items-center px-4 py-6">
          ...
          >
            ...
            <div className="flex justify-center mb-4">
              <div className="bg-white p-4 rounded-xl border-2 border-[#F6F6F6]">
                <QRCode
                  value={ticketData}
                  size={200}
                  level="H"
            ...
            <div className="relative bg-[#322F3C]/10 border-2 border-[#322F3C]/20 rounded-xl p-4 text-center">
